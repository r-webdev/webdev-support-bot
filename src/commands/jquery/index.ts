...
5. jQuery's cross-browser support can be substituted with the few polyfills you actually need. This also makes it easier to update when features become better supported.
6. If you really just want a shorthand for querySelectorAll, consider bling dot js`);
};
